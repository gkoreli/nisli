...
export { fit, columnsFor, cellFloor, shellMode, dialogMode, labelColumn, labelEvery, labelWidth, pageSize, columnBudgets, spreadSlack, textWeights, SORT_MARK_CHARS, type ColumnIntent, type ColumnBudget, type FitInput, type FitItem, type FitPlan, type FitDecision, type FitAction } from './engine/space.js';
