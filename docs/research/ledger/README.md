...
| Provider-independent bank domain | Implemented | Normalized signed minor units, opaque checkpoints, provenance, owner-write boundary, lifecycle/history, and safe rebuilds in ADR 0039. |
