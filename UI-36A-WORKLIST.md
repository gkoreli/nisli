...
- **Manual side-by-side pass**: wave-A ROW LEDGER CLOSED — 29 ☑ + 3 N/A = 32 rows resolved (vs live 39a8d36 + payoff deploy bca6c5d1); mobile DocsLayout drawer verified post-WWW-13. Former residual (avatar batch-2 NEW-surface Badge/Group/Count) CLOSED 2026-07-12 — four-surface chromium check PASS on the WWW-14 avatar-group demo (853313b0 / 4d4b6e6). Wave-A has NO open residual.
